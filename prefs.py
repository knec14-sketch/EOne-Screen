...
DEFAULTS = {
    ...
    # По умолчанию всё «system» - как настроено в самой Windows.
    # Человек уже выбрал там свои единицы, и спрашивать его второй раз
    # незачем; но переопределить можно каждую строчку.
    "units": {
        "temp": "system",      # system, c - Цельсий, f - Фаренгейт
        "wind": "system",      # system, kmh, ms или mph
        "clock": "system",     # system, 24 или 12 с AM и PM
        "date": "system",      # system или порядок чисел: dmy, mdy, ymd
