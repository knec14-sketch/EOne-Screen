...
Читайте это как есть: **Linux-машины у автора нет.** Всё, что ниже,
написано с чужого вывода терминала. Где никто ничего не подтверждал —
так и сказано.
...
**Чего никто ещё не подтверждал:** показания видеокарты из
`/sys/class/drm` — загрузка, видеопамять, мощность (разбор проверен
на подложенных файлах, но не на настоящей карте); автозапуск после
перезагрузки; ярлык в меню приложений. Если можете проверить хоть
что-то из этого — напишите в [issue #1][issue1].
